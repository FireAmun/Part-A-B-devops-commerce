...
<head>
    ...
    <title>Richiamo Caffe Login | UTM Commerce Connect</title>
    ...
    <div class="main-container">
        <div class="login-header">
            <h2>
                ...
                Richiamo Caffe Login
            </h2>
            <p>Access your coffee business dashboard</p>
        </div>
        ...
        <form method="POST" action="{{ route('vendor.login.richiamo') }}" id="login-form">
            @csrf
