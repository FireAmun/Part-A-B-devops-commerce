...
<head>
    ...
    <title>Richiamo Caffe Dashboard</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            gap: 2rem;
            box-shadow: 2px 0 8px rgba(139,69,19,0.15);
            z-index: 20;
        }
        .sidebar .logo {
            font-size: 1.7rem;
...
<body>
    <div class="layout">
        <div class="sidebar">
            <div class="logo" title="Richiamo Caffe"><i class="fas fa-mug-hot"></i></div>
            <nav class="sidebar-nav">
                <a href="{{ route('vendor2.dashboard.caffe') }}" class="active" title="Coffee Orders">
                    <i class="fas fa-coffee"></i>
                    <span class="tooltip">Coffee Orders</span>
                </a>
        ...
        <div class="main-section">
            <div class="header">
                <span>Richiamo Caffe Vendor Dashboard</span>
            ...
            <div class="main-content">
                <div class="container">
                    ...
                    <div id="orders-content">
                        <h1 id="orders-section">Coffee Orders</h1>
                        ...
                        <table class="orders-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('vendor2.dashboard.caffe.order.status', $order->id) }}" class="status-form">
                                            @csrf
                    ...
                    <div id="analytics-content" style="display: none;">
                        <h1>Richiamo Caffe Analytics</h1>

                        <div class="analytics-filters" style="background: #F5F5DC; padding: 1.5rem; border-radius: 12px; margin-bottom: 2rem;">
                            <form method="GET" id="analytics-form" style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
                                <label for="period" style="font-weight: 500; color: #654321;">Time Period:</label>
                                ...
                                <button type="button" onclick="updateAnalytics()" style="background: #8B4513; color: white; border: none; padding: 0.5rem 1rem; border-radius: 8px; cursor: pointer;">
                        ...
                        <div class="analytics-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
                            <div class="analytics-card" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                <h3 style="color: #654321; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
                            ...
                            <div class="analytics-card" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                <h3 style="color: #654321; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
                                    <i class="fas fa-mug-hot"></i> Coffee Orders
                                </h3>
                                <div class="metric-value" style="font-size: 2rem; font-weight: 700; color: #8B4513;">{{ $orders->count() }}</div>
                                <div class="metric-change" style="color: #059669; font-size: 0.9rem;">
                                    <i class="fas fa-arrow-up"></i> +10.7% from last period
                                </div>
                            </div>
                            ...
                            <div class="analytics-card" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                ...
                                <div class="metric-change" style="color: #059669; font-size: 0.9rem;">
                                    <i class="fas fa-arrow-up"></i> +3.1% from last period
                                </div>
                            </div>
                            ...
                            <div class="analytics-card" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                ...
                                <div class="metric-change" style="color: #059669; font-size: 0.9rem;">
                                    <i class="fas fa-arrow-up"></i> +7.8% from last period
                                </div>
                            </div>
                        </div>

                        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                            <div class="chart-container" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                <h3 style="color: #654321; margin-bottom: 1rem;">Daily Coffee Sales</h3>
                                <canvas id="salesChart" width="400" height="200"></canvas>
                            </div>

                            <div class="status-breakdown" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                                <h3 style="color: #654321; margin-bottom: 1rem;">Order Status</h3>
                        ...
                        <div class="top-products" style="background: white; padding: 1.5rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);">
                            <h3 style="color: #654321; margin-bottom: 1rem;">Popular Beverages</h3>
                            <div style="overflow-x: auto;">
                                <table style="width: 100%; border-collapse: collapse;">
                                    <thead>
                                        <tr style="border-bottom: 2px solid #e5e7eb;">
                                            <th style="text-align: left; padding: 0.75rem; color: #654321;">Beverage</th>
                                            <th style="text-align: left; padding: 0.75rem; color: #654321;">Orders</th>
                                            <th style="text-align: left; padding: 0.75rem; color: #654321;">Revenue</th>
                                            <th style="text-align: left; padding: 0.75rem; color: #654321;">Avg. Price</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                    ...
                    <div id="products-content" style="display: none;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                            ...
                            <a href="{{ route('vendor2.products.create') }}" style="background: #8B4513; color: white; padding: 0.75rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 0.5rem;">
                                <i class="fas fa-plus"></i>
                                Add New Item
                            </a>
                        </div>

                        <iframe src="{{ route('vendor2.products') }}" style="width: 100%; height: 600px; border: none; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08);"></iframe>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="font-size: 0.85rem; color: #6b4a2d;">{{ $complaint->user_email }}</div>
                                        </td>
                                        <td>
                                            <div style="font-weight: 600;">{{ $complaint->subject }}</div>
                                            <div style="font-size: 0.9rem; color: #6b4a2d; margin-top: 0.25rem;">
                                        ...
                                        <td>
                                            <form method="POST" action="{{ route('vendor.complaints.updateStatus', $complaint->id) }}" class="status-form" style="flex-direction: column; align-items: stretch; gap: 0.5rem;">
                                                ...
                                                <textarea name="admin_response" placeholder="Add your response (optional)" rows="2" style="padding: 0.35rem 0.7rem; border-radius: 7px; border: 1px solid #e5e7eb; font-size: 0.97rem; background: #F5F5DC; color: #2F1B14; resize: vertical;">{{ $complaint->admin_response }}</textarea>
                    ...
                    <div id="settings-content" style="display: none;">
                        ...
                        <div style="background: white; padding: 2rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(139,69,19,0.08); max-width: 600px;">
                            <h3 style="color: #654321; margin-bottom: 1.5rem; display: flex; align-items: center; gap: 0.5rem;">
                                <i class="fas fa-key"></i> Change Password
                            </h3>

                            <div id="password-step-1">
                                <p style="margin-bottom: 1rem; color: #6b4a2d;">Enter your email to receive an OTP for password verification.</p>
                                <div style="display: flex; gap: 1rem; margin-bottom: 1rem;">
                                    <input type="email" id="vendor-email" placeholder="Enter your email"
                                           value="richiamocaffe@gmail.com" readonly
                                           style="flex: 1; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 8px; background: #F5F5DC;">
                                    <button onclick="sendOTP()" id="send-otp-btn"
                                            style="background: #8B4513; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 8px; cursor: pointer; font-weight: 500;">
                                        Send OTP
                                    </button>
                                </div>
                            </div>
                            ...
                            <div id="password-step-2" style="display: none;">
                                <p style="margin-bottom: 1rem; color: #6b4a2d;">Enter the OTP sent to your email and your new password.</p>
            ...
            <div class="footer">
                &copy; {{ date('Y') }} UTM Commerce Connect - Richiamo Caffe. All rights reserved.
            </div>
        </div>
    </div>
    ...
    <script>
        function toggleSection(section) {
            ...
            if (section === 'analytics') {
                ...
                const ordersLink = document.querySelector('a[href*="caffe"]');
        ...
        function updateAnalytics() {
            ...
            console.log('Updating coffee analytics for period:', period);
            ...
            const url = `{{ route('vendor2.dashboard.caffe.analytics') }}?period=${period}`;
        ...
        function initializeCharts(dailySalesData = null) {
            ...
            const salesData = dailySalesData || [85, 120, 180, 220, 160, 280, 320];
