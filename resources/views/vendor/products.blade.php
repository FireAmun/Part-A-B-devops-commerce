                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            <a href="{{ route('vendor.products.edit', $product->id) }}" class="btn btn-edit" target="_parent">
                                <i class="fas fa-edit"></i>
                                Edit
                            </a>
                            <form method="POST" action="{{ route('vendor.products.delete', $product->id) }}" style="display: inline;" onsubmit="return confirm('Are you sure?')">
                                @csrf
                                @method('DELETE')
