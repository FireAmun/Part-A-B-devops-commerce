...
<head>
    ...
    <title>{{ isset($product) ? 'Edit' : 'Add' }} Product - UTM Mart</title>
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="{{ isset($product) ? route('vendor.products.update', $product->id) : route('vendor.products.store') }}">
            @csrf
            @if(isset($product))
                @method('PUT')
            @endif
