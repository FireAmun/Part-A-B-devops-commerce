...
<head>
    <meta charset="UTF-8">
    <title>Your Printing Wishlist - Setepak Printing Service KTF</title>
...
<body>
    <div class="container">
        ...
        <h2><i class="fas fa-heart"></i><i class="fas fa-print"></i> Your Printing Wishlist</h2>
        @if(count($wishlist) > 0)
                ...
                @foreach($wishlist as $id => $item)
                    <div class="wishlist-card">
                        @php
                            ...
                            $iconClass = '';
                            // For vendor_id=3 or printing-related products, always use icons
                            if ($imagePath === 'icon' || (isset($item['vendor_id']) && $item['vendor_id'] == 3)) {
                                $imagePath = 'icon'; // Ensure icon is used for all vendor3 (printing) products
        ...
        @else
            <div class="empty">
                ...
                <p>Your printing wishlist is empty.</p>
            </div>
        @endif
    </div>
</body>
