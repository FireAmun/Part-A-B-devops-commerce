...
<head>
    ...
    <style>
        /* ...existing styles from edit.blade.php... */
        :root {
            --primary: #2563eb;
            --primary-dark: #1e40af;
            --secondary: #3b82f6;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input { width: 100%; padding: 0.875rem 1rem; border: 2px solid var(--gray-200); border-radius: 8px; font-size: 1rem; transition: all 0.2s; background: var(--gray-50); }
